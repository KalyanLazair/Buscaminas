...
public class VentanaBuscaminas extends javax.swing.JFrame {
    ...
    Boton[][] arrayBotones= new Boton[filas][columnas]; //Los botones los hemos sacado a una clase.
    ...
    public VentanaBuscaminas() {
        initComponents();
        setSize(800,600);
        //getContentPane apunta al jFrame porque vamos a cambiar una propiedad.
        getContentPane().setLayout(new GridLayout(filas,columnas));
        //Este bucle for crea los botones que vamos a utilizar en el panel del buscaminas.
        for(int i=0; i<filas; i++){
           for(int j=0;j<columnas;j++){
             Boton boton=new Boton(i,j);
             //boton.setBorder(null);
             getContentPane().add(boton); //añade el boton a la vista.
             arrayBotones[i][j]=boton; //Añade los botones al array que hemos creado.
    ...
    private void botonPulsado(MouseEvent e){
           Boton miBoton= (Boton) e.getComponent(); //Le preguntamos qué botón del ratón ha sido pulsado.
    ...
    private void ponMinas(int numeroMinas){
         ...
         for(int i=0; i<numeroMinas; i++){
            ...
            //TODO: Hacer versión que chequée si en la casilla seleccionada ya hay una mina.
            //En ese caso tiene que buscar otra.
